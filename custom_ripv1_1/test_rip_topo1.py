...
class NetworkTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        router[2] = topotest.addRouter(self, 'r2')
        router[3] = topotest.addRouter(self, 'r3')
        #
        host1 = self.addHost('h1', ip='192.168.10.30/28')
        host2 = self.addHost('h2', ip='192.168.10.62/27')
        host3 = self.addHost('h3', ip='192.168.10.46/29')
        self.addLink(router[1], router[2])
        self.addLink(router[2], router[3])
        self.addLink(router[3], router[1])
        self.addLink(host1, router[1])
        self.addLink(host2, router[2])
        self.addLink(host3, router[3])
